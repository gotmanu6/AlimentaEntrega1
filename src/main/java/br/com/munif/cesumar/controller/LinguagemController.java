...
public class LinguagemController {
    ...
    @PostMapping
    @ApiResponse(responseCode = "201", description = "Linguagem criada", headers =
            @Header(name = "Location", description = "URL da linguagem criada",
    ...
    @DeleteMapping("/{id}")
    @ApiResponse(responseCode = "204", description = "Linguagem excluída")
