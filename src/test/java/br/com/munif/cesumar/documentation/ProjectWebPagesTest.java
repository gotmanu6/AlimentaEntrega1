...
class ProjectWebPagesTest {
    ...
    @MockitoBean
    private br.com.munif.cesumar.service.DoacaoService doacaoService;

    @MockitoBean
    private br.com.munif.cesumar.service.PontoColetaService pontoColetaService;
    ...
    void deveGerarContratoOpenApiDosEndpointsDeLinguagens() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/linguagens'].post.responses['201']").exists())
                .andExpect(jsonPath("$.paths['/api/linguagens'].post.responses['201'].headers.Location").exists())
                .andExpect(jsonPath("$.paths['/api/linguagens/{id}'].delete.responses['204']").exists())
                .andExpect(jsonPath("$.paths['/api/linguagens/{id}'].delete.responses['204'].content").doesNotExist())
